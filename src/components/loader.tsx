...
const Loader: React.FC<LoaderProps> = ({ 
  ...
  useEffect(() => {
    ...
    if (!isRouteTransition) {
      ...
      .from(centerContentRef.current, {
        scale: 0.8,
        opacity: 0,
        duration: 0.6,
        ease: 'expo.out',
      }, '-=0.2')
      .from(loadingTextRef.current, {
        x: -30,
        opacity: 1,
        duration: 0.8,
        ease: 'power3.out',
      }, '-=0.4')
      .from(progressTextRef.current, {
        x: 30,
        opacity: 1,
        duration: 0.8,
        ease: 'power3.out',
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <div className="w-16 h-16 bg-white/10 rounded-sm flex items-center justify-center">
            <div className="text-[#3B2E34] text-2xl font-bold"><img src={kci} alt="" /></div>
          </div>
...
export const LoaderProvider: React.FC<{ children: React.ReactNode }> = ({ 
  ...
  const [currentAssets, setCurrentAssets] = useState<PreloadAssets>({ images: [] });
...
//   const initialAssets: PreloadAssets = {
//     images: [
...
//     ],
//     fonts: ['Inter', 'Roboto'], // Replace with your actual fonts
//   };
...
//             <h1 className="text-4xl font-bold mb-4">KANNCOMP INDIA</h1>
//             <p className="text-gray-400">Premium Steel Fabrication</p>
